import { O as createLucideIcon, h as useGoogleAuth, V as useNavigate, a6 as useMyProfile, i as useMyPostedRides, k as useMyBookings, a7 as useUpdateUserProfile, r as reactExports, j as jsxRuntimeExports, a8 as User, B as Button, q as LoaderCircle, t as motion, a9 as LogOut, S as Skeleton, aa as Avatar, ab as AvatarImage, ac as AvatarFallback, M as MapPin, ad as StarRating, ae as ShieldCheck, Z as Label, $ as Input, af as MessageCircle, a1 as PawPrint, a2 as Cigarette, a3 as Briefcase, x as Car, K as ue } from "./index-Df8kOu0f.js";
import { T as Textarea } from "./textarea-CrFbrQIs.js";
import { b as isRideCompleted, c as isBookingConfirmed } from "./index-DkmPAu21.js";
import { E as ExternalLink, L as Linkedin } from "./linkedin-ipK8kCtW.js";
...
function ProfilePage() {
  ...
  const [chatPref, setChatPref] = reactExports.useState("");
  const [petsPreference, setPetsPreference] = reactExports.useState("");
  const [smokingPreference, setSmokingPreference] = reactExports.useState("");
  const [luggagePreference, setLuggagePreference] = reactExports.useState("");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "container py-8 max-w-2xl px-4 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
            ...
            motion.form,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 pt-2 border-t border-border", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-sm uppercase tracking-wider text-muted-foreground", children: "Ride Preferences" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    PrefToggle,
                    {
                      label: "Chat Preference",
                      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "h-4 w-4" }),
                      value: chatPref,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 pt-2 border-t border-border", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Fill these if you post rides as a driver" })
                  ] }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 pt-2 border-t border-border", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-sm uppercase tracking-wider text-muted-foreground", children: "Social Profile *" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "At least one social profile required for trust verification" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      Label,
        ...
        !isEditing && profile && (profile.chatPref || profile.petsPreference || profile.smokingPreference || profile.luggagePreference) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-4 sm:p-5 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-sm uppercase tracking-wider text-muted-foreground mb-3", children: "Ride Preferences" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2", children: [
            profile.chatPref && /* @__PURE__ */ jsxRuntimeExports.jsx(
              PrefChip,
              {
                icon: /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "h-3.5 w-3.5" }),
                label: profile.chatPref === "chatty" ? "Chatty during ride" : "Quiet ride preferred"
              }
            ),
            profile.petsPreference && /* @__PURE__ */ jsxRuntimeExports.jsx(
              PrefChip,
              {
                icon: /* @__PURE__ */ jsxRuntimeExports.jsx(PawPrint, { className: "h-3.5 w-3.5" }),
                label: profile.petsPreference === "allowed" ? "Pets allowed" : "Pets not allowed"
              }
            ),
            profile.smokingPreference && /* @__PURE__ */ jsxRuntimeExports.jsx(
              PrefChip,
              {
                icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Cigarette, { className: "h-3.5 w-3.5" }),
                label: profile.smokingPreference === "allowed" ? "Smoking allowed" : "No smoking in car"
              }
            ),
            profile.luggagePreference && /* @__PURE__ */ jsxRuntimeExports.jsx(
              PrefChip,
              {
                icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Briefcase, { className: "h-3.5 w-3.5" }),
                label: profile.luggagePreference === "allowed" ? "Luggage allowed" : profile.luggagePreference === "limited" ? "Limited luggage" : "No luggage"
              }
            )
          ] })
        ] }),
...
function PrefToggle({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: options.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        onClick: () => onChange(value === opt.value ? "" : opt.value),
        className: `px-3 py-1.5 rounded-full text-sm border transition-colors ${value === opt.value ? "bg-primary text-primary-foreground border-primary" : "bg-background border-border text-foreground hover:border-primary/50"}`,
        children: opt.label
      },
      opt.value
    )) })
...
function PrefChip({ icon, label }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs border border-primary/30 bg-primary/5 text-primary", children: [
    icon,
    label
  ] });
}
