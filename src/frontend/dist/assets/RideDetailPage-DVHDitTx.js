import { z as createLucideIcon, r as reactExports, j as jsxRuntimeExports, h as LoaderCircle, M as MapPin, ai as useParams, V as useNavigate, u as useGoogleAuth, aj as useRideDetail, b as useMyBookings, ak as useGetUserProfile, al as useBookRide, w as Skeleton, B as Button, m as motion, o as Clock, a0 as Users, am as MessageCircle, a1 as PawPrint, a2 as Cigarette, a3 as Briefcase, y as cn, a4 as Zap, a5 as ClipboardCheck, k as Link, a9 as Avatar, aa as AvatarImage, ab as AvatarFallback, ac as StarRating, x as ue } from "./index-o36hOOSD.js";
import { A as AlertDialog, b as AlertDialogContent, c as AlertDialogHeader, d as AlertDialogTitle, e as AlertDialogDescription, f as AlertDialogFooter, g as AlertDialogCancel, h as AlertDialogAction } from "./alert-dialog-CLd4UOD2.js";
import { b as isRideActive, a as isBookingConfirmed, i as isBookingPending, d as getBookingStatusLabel } from "./index-DeBgwukp.js";
import { A as ArrowLeft } from "./arrow-left-DA-J5keZ.js";
import { B as Banknote } from "./banknote-VBG0z9xc.js";
...
function RideDetailPage() {
  ...
  const handleBook = async () => {
    ...
    if (razorpayKeyId) {
      ...
      if (!loaded) {
        ue.error("Payment gateway failed to load. Please try again.");
        return;
      }
      const options = {
        key: razorpayKeyId,
        ...
        handler: async () => {
          try {
            ...
            ue.success("Payment successful! Ride booked.");
          } catch (err) {
            ue.error((err == null ? void 0 : err.message) || "Booking failed after payment");
          }
        },
        prefill: { name: ((_a2 = identity == null ? void 0 : identity.getPrincipal()) == null ? void 0 : _a2.toString()) ?? "" },
        modal: { ondismiss: () => ue("Payment cancelled") }
      };
      ...
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-6 mb-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2 mb-6", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-2xl sm:text-4xl font-display font-black text-primary", children: [
                  "₹",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-xl p-4", children: !isLoggedIn ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-4", children: [
            ...
            isBookingConfirmed(myBookingForRide.status) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                asChild: true,
                variant: "outline",
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/tracking/$rideId", params: { rideId }, children: [
