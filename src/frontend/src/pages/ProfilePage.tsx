...
export function ProfilePage() {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    if (userRole === "driver" && !facebookUrl.trim() && !linkedinUrl.trim()) {
      ...
      toast.error("Drivers must add a LinkedIn or Facebook profile link.");
      return;
    }
    try {
  ...
  if (!identity) {
    return (
      <main className="container py-16 max-w-lg text-center px-4 sm:px-6">
        ...
        <h1 className="font-bold text-2xl mb-2">Sign in to view profile</h1>
    ...
    <main className="container py-6 max-w-2xl px-4 sm:px-6 pb-24">
      ...
      >
        ...
        <Tabs defaultValue="profile" className="w-full">
          <TabsList className="w-full grid grid-cols-2 h-10 mb-1">
            <TabsTrigger
              value="profile"
              className="gap-1.5"
              ...
              >
                ...
                {completionCount < 6 && (
                  <p className="text-xs text-muted-foreground mt-2">
                    Complete your profile to build trust with riders and
                    drivers.
                  </p>
                )}
              </div>
              ...
              {profileLoading ? (
                ...
                <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
                  ...
                  <div className="flex-1 min-w-0">
                    <h2 className="font-bold text-2xl mb-1 break-words">
          ...
          <TabsContent value="account" className="mt-0 space-y-0">
            <div className="rounded-xl border border-border bg-card overflow-hidden divide-y divide-border">
              ...
              <div>
                ...
                {/* Close account with AlertDialog */}
                <AlertDialog
                ...
                >
                  ...
                  <AlertDialogContent data-ocid="profile.close_account.dialog">
                    <AlertDialogHeader>
                    ...
                    <AlertDialogFooter>
                      <AlertDialogCancel data-ocid="profile.close_account.cancel_button">
                        Cancel
                      </AlertDialogCancel>
                      <AlertDialogAction
