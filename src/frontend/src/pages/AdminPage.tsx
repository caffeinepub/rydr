...
function SettingsTab() {
  ...
  const saveRazorpay = () => {
    if (razorpayKeyId.trim()) {
      ...
      toast.success("Payment gateway configuration removed.");
    }
  };
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">
          Configure external integrations for RYDR
        </p>
      </div>

      {/* Google OAuth */}
      <Card data-ocid="admin.settings.google_oauth_card">
        <CardHeader>
          <div className="flex items-center justify-between gap-3 flex-wrap">
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-0.5">
                Configure Google Sign-In for your users
              </p>
            </div>
            <Badge
              className={
            ...
            >
              {isGoogleConfigured ? "Configured" : "Not configured"}
            </Badge>
          </div>
        </CardHeader>
        <CardContent className="space-y-4">
      ...
      {/* Razorpay */}
      <Card data-ocid="admin.settings.razorpay_card">
        <CardHeader>
          <div className="flex items-center justify-between gap-3 flex-wrap">
            <div>
              <CardTitle className="text-base">Payment Gateway</CardTitle>
              <p className="text-sm text-muted-foreground mt-0.5">
                Configure Razorpay for ride payments
              </p>
            </div>
            <Badge
              className={
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            />
            <Label htmlFor="rzp-sandbox">Sandbox mode (test payments)</Label>
          </div>
          <p className="text-xs text-muted-foreground">
